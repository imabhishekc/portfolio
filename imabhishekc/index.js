...
document.querySelector('#resume-link-1').addEventListener("click", () => {
    ...
    // window.location.assign("https://drive.google.com/file/d/1swLV9KLDcFtYdSf9BdBs0Pa7JK4iEOR_/view?usp=sharing", "_blank");
    window.open('https://drive.google.com/file/d/1swLV9KLDcFtYdSf9BdBs0Pa7JK4iEOR_/view?usp=sharing',"_blank");
})
